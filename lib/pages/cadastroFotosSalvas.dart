...
import 'package:nomundodasluas_v7/classes/LeAuth.dart';
import 'package:nomundodasluas_v7/classes/rowAppBar.dart';
import 'package:nomundodasluas_v7/pages/fotossalvas.dart';

class CadastroFotosSalvas extends StatefulWidget {
  @override
  _CadastroFotosSalvasState createState() => _CadastroFotosSalvasState();
}

class _CadastroFotosSalvasState extends State<CadastroFotosSalvas> {
  ...
  verificaEmail() async {
    ...
    if (nome.isNotEmpty &&
      ...
      if ((_autoriza == 'autorizado') || (_autoriza == 'jaCadastrado')) {
        Navigator.push(this.context, MaterialPageRoute(builder: (context) {
          return FotosSalvas(_controllerEmail.text);
        }));
      } else {
        {
          setState(() {
              ...
              children: <Widget>[
                Expanded(
                    ...
                    child: Container(
                        ...
                        child: Text(
                          "Para ter acesso a fotos salvas, é necessario o cadastro de e-mail. Caso já seja cadastrado" +
